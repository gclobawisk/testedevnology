...
<div class="container-fluid">
                    <div class="d-sm-flex justify-content-between align-items-center mb-4">
                        ...
                        <a class="btn btn-success btn-sm d-none d-sm-inline-block" role="button" href="javascript: if(confirm('Deseja Realizar Crawling na DevGo?')) location.href='http://44.205.3.29:5000'" ><i class="fas fa-link fa-sm text-white-50"></i>&nbsp;Fazer Crawler</a>
                        <a class="btn btn-danger btn-sm d-none d-sm-inline-block" role="button" href="javascript: if(confirm('Deseja Apagar todos os Links deste Blog?')) location.href='http://devnology.siteprofissional.com/deletartodososlinks'"><i class="fas fa-trash fa-sm text-white-50"></i>&nbsp;Apagar Links</a>
                                ...
                                <table class="table my-0" id="dataTable">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td><a style="color:red;" href="javascript: if(confirm('Deseja Deletar esse Registro?')) location.href='../events/deletarlink/{{$row->li_id}}/{{$row->li_blog_id}}'"><i class="fas fa-trash"></i></a></td>
...
<script src="http://devnology.siteprofissional.com/assets_admin/assets/js/editarlinks.js"></script>
